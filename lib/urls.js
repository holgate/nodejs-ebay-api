...
exports.buildRequestUrl = function(options) {
  ...
  switch (serviceName) {
      //no need to change suffix in api. It redirects according to 'X-EBAY-SOA-GLOBAL-ID'
    case 'Finding':
      if (options.sandbox) url = 'https://svcs.sandbox.ebay.{extension}/services/search/FindingService/v1';
      else url = 'https://svcs.ebay.{extension}/services/search/FindingService/v1';     // no HTTPS support, really?!
      break;
    ...
    case 'Product':
      ...
      //Shopping Api doesnt have a locale endpoint. It works differently //https://developer.ebay.com/devzone/shopping/docs/CallRef/GetSingleItem.html
 case 'Shopping':
  ...
  //var extension = countryHelper.getExtension(options.country);
  var extension = 'com'; //endpoints don't change but nice method
